class CreateCitiesAndStatesTable < ActiveRecord::Migration
  def up
    execute "CREATE TABLE IF NOT EXISTS `countries` (
  ...
  execute "INSERT INTO `countries` (`id`, `name`, `acronym`) VALUES (1, 'Brasil', 'BR');"
  ...
  execute "INSERT INTO `states` (`id`, `name`, `acronym`, `country_id`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
execute "CREATE TABLE IF NOT EXISTS `cities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
execute "INSERT INTO `cities` (`id`, `name`, `state_id`) VALUES
(1, 'Afonso Cláudio', 8),
